...
dependencies {
  ...
  prestoDependencies("implementation", crossEngine.presto)
...
tasks.withType<Test>().configureEach {
  ...
  systemProperty("presto.prestoMajorVersion", crossEngine.presto.prestoMajorVersion)
  systemProperty("presto.prestoVersion", crossEngine.presto.prestoVersion)
}
