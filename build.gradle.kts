...
tasks.register("publishLocal") {
  ...
  listOf("nessie", "iceberg", "nessie-iceberg").forEach { includedBuildName ->
    val inclBuild = gradle.includedBuild(includedBuildName)
    ...
    inclBuildTarget.projects.allProjects.forEach { projectState ->
      val taskDependency =
        inclBuild.task("${projectState.projectPath}:publishToMavenLocal") as TaskDependencyContainer
