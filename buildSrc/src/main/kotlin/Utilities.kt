...
fun Project.getCrossEngineVersionsForProject(): CrossEngineVersions {
  ...
  val prestoMajorVersion = splits[6]
  return CrossEngineVersions(
    ...
    usePrestoVersionsForProject(prestoMajorVersion)
  )
}

class CrossEngineVersions(
  val sparkScala: SparkScalaVersions,
  val flink: FlinkVersions,
  val presto: PrestoVersions
) {}
