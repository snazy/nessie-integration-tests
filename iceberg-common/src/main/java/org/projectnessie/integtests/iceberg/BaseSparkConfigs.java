...
public interface BaseSparkConfigs extends BaseSpark {
  ...
  AtomicReference<String> initialHashOfMainBranch = new AtomicReference<>();
  ...
  static void setupApi() throws Exception {
    ...
    NESSIE_API.set(api);
    initialHashOfMainBranch.set(api.getDefaultBranch().getHash());
  }
  ...
  default void resetNessie() throws Exception {
    ...
    api()
        .assignBranch()
        .assignTo(Branch.of(defaultBranch.getName(), initialHashOfMainBranch.get()))
