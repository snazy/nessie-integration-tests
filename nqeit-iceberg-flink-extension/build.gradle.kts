...
val flink =
  useFlinkVersionsForProject(
    rootProject.extra["flinkMinimalVersion"].toString(),
    rootProject.extra["scalaMinimalVersion"].toString()
  )
...
dependencies {
  ...
  icebergFlinkDependencies("compileOnly", flink)
}
